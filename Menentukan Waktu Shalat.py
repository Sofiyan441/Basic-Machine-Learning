...
#Koordinat Lokasi
inLL = input (" Masukkan Lintang Lokasi   = ") #Lintang lokasi
LL = float (inLL)
LLR = radians(LL)

inBL = input (" Masukkan Bujur Lokasi     = ") #Bujur lokasi
BL = float (inBL)

#Tanggal
inH = input (" Masukkan Tanggal Awal      = ") #Hari awal
H = int (inH)
inHa = input (" Masukkan Tanggal Akhir    = ") #Hari akhir
Ha = int (inHa)
inB = input (" Masukkan Bulan             = ") #Bulan
B = int (inB)
inT = input (" Masukkan Tahun             = ") #Tahun
T = int (inT)

#Data lainnya
inKL = input (" Masukkan Ketinggian Lokasi = ") #Ketinggian lokasi (meter)
KL = float (inKL)
inTZ = input (" Masukkan Zona Waktu Lokasi = ") #Time Zone (GMT)
TZ = float (inTZ)
print("")
